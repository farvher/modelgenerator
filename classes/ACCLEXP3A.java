 ...
 * @author Cobiscorp
 */
public class ACCLEXP3A implements Serializable{
...
//getters
    ...
    private ACCLEXP3A(Builder builder){
    ...
    public static Builder newACCLEXP3A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLEXP3A build() {
                return new ACCLEXP3A(this);
            }
