 ...
 * @author Cobiscorp
 */
public class ACCLEXP4A implements Serializable{
...
//getters
    ...
    private ACCLEXP4A(Builder builder){
    ...
    public static Builder newACCLEXP4A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLEXP4A build() {
                return new ACCLEXP4A(this);
            }
