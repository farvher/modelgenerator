 ...
 * @author Cobiscorp
 */
public class ACCLMLD1A implements Serializable{
...
//getters
    ...
    private ACCLMLD1A(Builder builder){
    ...
    public static Builder newACCLMLD1A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLMLD1A build() {
                return new ACCLMLD1A(this);
            }
