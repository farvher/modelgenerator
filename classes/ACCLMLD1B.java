 ...
 * @author Cobiscorp
 */
public class ACCLMLD1B implements Serializable{
...
//getters
    ...
    private ACCLMLD1B(Builder builder){
    ...
    public static Builder newACCLMLD1B() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLMLD1B build() {
                return new ACCLMLD1B(this);
            }
