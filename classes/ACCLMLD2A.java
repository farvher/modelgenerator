 ...
 * @author Cobiscorp
 */
public class ACCLMLD2A implements Serializable{
...
//getters
    ...
    private ACCLMLD2A(Builder builder){
    ...
    public static Builder newACCLMLD2A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLMLD2A build() {
                return new ACCLMLD2A(this);
            }
