 ...
 * @author Cobiscorp
 */
public class ACCLMLD3A implements Serializable{
...
//getters
    ...
    private ACCLMLD3A(Builder builder){
    ...
    public static Builder newACCLMLD3A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLMLD3A build() {
                return new ACCLMLD3A(this);
            }
