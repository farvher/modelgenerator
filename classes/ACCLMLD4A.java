 ...
 * @author Cobiscorp
 */
public class ACCLMLD4A implements Serializable{
...
//getters
    ...
    private ACCLMLD4A(Builder builder){
    ...
    public static Builder newACCLMLD4A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLMLD4A build() {
                return new ACCLMLD4A(this);
            }
