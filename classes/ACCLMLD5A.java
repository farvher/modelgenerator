 ...
 * @author Cobiscorp
 */
public class ACCLMLD5A implements Serializable{
...
//getters
    ...
    private ACCLMLD5A(Builder builder){
    ...
    public static Builder newACCLMLD5A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLMLD5A build() {
                return new ACCLMLD5A(this);
            }
