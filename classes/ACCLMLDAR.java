 ...
 * @author Cobiscorp
 */
public class ACCLMLDAR implements Serializable{
...
//getters
    ...
    private ACCLMLDAR(Builder builder){
    ...
    public static Builder newACCLMLDAR() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public ACCLMLDAR build() {
                return new ACCLMLDAR(this);
            }
