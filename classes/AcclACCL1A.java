 ...
 * @author Cobiscorp
 */
public class AcclACCL1A implements Serializable{
...
//getters
    ...
    private AcclACCL1A(Builder builder){
    ...
    public static Builder newAcclACCL1A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCL1A build() {
                return new AcclACCL1A(this);
            }
