 ...
 * @author Cobiscorp
 */
public class AcclACCL3A implements Serializable{
...
//getters
    ...
    private AcclACCL3A(Builder builder){
    ...
    public static Builder newAcclACCL3A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCL3A build() {
                return new AcclACCL3A(this);
            }
