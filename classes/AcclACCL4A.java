 ...
 * @author Cobiscorp
 */
public class AcclACCL4A implements Serializable{
...
//getters
    ...
    private AcclACCL4A(Builder builder){
    ...
    public static Builder newAcclACCL4A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCL4A build() {
                return new AcclACCL4A(this);
            }
