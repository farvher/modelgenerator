 ...
 * @author Cobiscorp
 */
public class AcclACCL5A implements Serializable{
...
//getters
    ...
    private AcclACCL5A(Builder builder){
    ...
    public static Builder newAcclACCL5A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCL5A build() {
                return new AcclACCL5A(this);
            }
