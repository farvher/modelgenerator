 ...
 * @author Cobiscorp
 */
public class AcclACCLAR implements Serializable{
...
//getters
    ...
    private AcclACCLAR(Builder builder){
    ...
    public static Builder newAcclACCLAR() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLAR build() {
                return new AcclACCLAR(this);
            }
