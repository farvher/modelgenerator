 ...
 * @author Cobiscorp
 */
public class AcclACCLEXP1A implements Serializable{
...
//getters
    ...
    private AcclACCLEXP1A(Builder builder){
    ...
    public static Builder newAcclACCLEXP1A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLEXP1A build() {
                return new AcclACCLEXP1A(this);
            }
