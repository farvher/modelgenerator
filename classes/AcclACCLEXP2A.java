 ...
 * @author Cobiscorp
 */
public class AcclACCLEXP2A implements Serializable{
...
//getters
    ...
    private AcclACCLEXP2A(Builder builder){
    ...
    public static Builder newAcclACCLEXP2A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLEXP2A build() {
                return new AcclACCLEXP2A(this);
            }
