 ...
 * @author Cobiscorp
 */
public class AcclACCLEXP5A implements Serializable{
...
//getters
    ...
    private AcclACCLEXP5A(Builder builder){
    ...
    public static Builder newAcclACCLEXP5A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLEXP5A build() {
                return new AcclACCLEXP5A(this);
            }
