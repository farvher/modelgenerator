 ...
 * @author Cobiscorp
 */
public class AcclACCLMLD1A implements Serializable{
    ...
    @NotNull(message = "etc cannot be null")
    @Size(max = 264, min = 1)
    private String etc;
    ...
    @NotNull(message = "cod_compensador cannot be null")
    @NotBlank(message = "cod_compensador cannot be blank")
    @Size(max = 4, min = 1)
...
//getters
    ...
    private AcclACCLMLD1A(Builder builder){
        ...
        this.codCompensador = builder.codCompensador;
    ...
    public static Builder newAcclACCLMLD1A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLMLD1A build() {
                return new AcclACCLMLD1A(this);
            }
            ...
            public Builder withCodCompensador(String codCompensador) {
