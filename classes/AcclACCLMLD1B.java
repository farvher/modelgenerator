 ...
 * @author Cobiscorp
 */
public class AcclACCLMLD1B implements Serializable{
...
//getters
    ...
    private AcclACCLMLD1B(Builder builder){
    ...
    public static Builder newAcclACCLMLD1B() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLMLD1B build() {
                return new AcclACCLMLD1B(this);
            }
