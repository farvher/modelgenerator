 ...
 * @author Cobiscorp
 */
public class AcclACCLMLD2A implements Serializable{
...
//getters
    ...
    private AcclACCLMLD2A(Builder builder){
    ...
    public static Builder newAcclACCLMLD2A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLMLD2A build() {
                return new AcclACCLMLD2A(this);
            }
