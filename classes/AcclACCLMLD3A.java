 ...
 * @author Cobiscorp
 */
public class AcclACCLMLD3A implements Serializable{
...
//getters
    ...
    private AcclACCLMLD3A(Builder builder){
    ...
    public static Builder newAcclACCLMLD3A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLMLD3A build() {
                return new AcclACCLMLD3A(this);
            }
