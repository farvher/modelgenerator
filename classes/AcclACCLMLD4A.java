 ...
 * @author Cobiscorp
 */
public class AcclACCLMLD4A implements Serializable{
...
//getters
    ...
    private AcclACCLMLD4A(Builder builder){
    ...
    public static Builder newAcclACCLMLD4A() {
            return new Builder();
    }
      ...
      public static class Builder {
            ...
            public AcclACCLMLD4A build() {
                return new AcclACCLMLD4A(this);
            }
